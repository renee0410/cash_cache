...
const Input: FC<InputProps> = ({ label, name, type, required, pattern, minLength = 1, maxLength = 100, validate }) => {
  // i18n
    ...
    <>
      <label htmlFor={name} className='flex flex-col'>
        ...
        <input
          ...
          className={cn('rounded-lg border border-gray-200 px-3 py-2 placeholder:text-sm', {
